        ...
        <table cellpadding="10" border="1">
            <tbody>
                ...
                <tr>
                    ...
                    <td>3 days</td>
                    <td>$1200.00</td>
                    <td>8 hours per day</td>Use Control + Shift + m to toggle the tab key moving focus. Alternatively, use esc then tab to move to the next interactive element on the page.
